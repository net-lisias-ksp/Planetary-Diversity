...
{
    /// <summary>
    /// Tweaks the seed of the VertexSimplexHeightAbsolute PQSMod
    /// </summary>
    public class VertexSimplexHeightAbsoluteTweak : PQSModTweaker<PQSMod_VertexSimplexHeightAbsolute>
    {
        /// <summary>
        ...
        /// </summary>
        public override String GetSetting() => "VertexSimplexHeightAbsolute";

        /// <summary>
        /// Changes the parameters of the PQSMod
        /// </summary>
        public override Boolean Tweak(CelestialBody body, PQSMod_VertexSimplexHeightAbsolute mod)
        {
