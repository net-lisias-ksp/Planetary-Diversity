...
{
    /// <summary>
    /// Tweaks the seed of the VertexSimplexHeightFlatten PQSMod
    /// </summary>
    public class VertexSimplexHeightFlattenTweak : PQSModTweaker<PQSMod_VertexSimplexHeightFlatten>
    {
        /// <summary>
        ...
        /// </summary>
        public override String GetSetting() => "VertexSimplexHeightFlatten";

        /// <summary>
        /// Changes the parameters of the PQSMod
        /// </summary>
        public override Boolean Tweak(CelestialBody body, PQSMod_VertexSimplexHeightFlatten mod)
        {
